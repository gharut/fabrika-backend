    ...
    public function run(): void
    {
        $templates = [
            [
                ...
                'name' => 'ШК',
                'is_system' => true,
                'content' => '{"page":{"w":58,"h":40,"pad":1,"grid":0.5,"snap":true},"blocks":[{"id":"t1","type":"text","x":2,"y":4.5,"w":54,"h":6,"text":"{{name}}","style":{"bold":true,"align":"center","size":2.7}},{"id":"t6icuq","type":"text","x":2,"y":11.5,"w":33.5,"h":3.5,"text":"Артикул: {{article}} ","style":{"size":2.4}},{"id":"tj05ij","type":"text","x":2,"y":18,"w":33.5,"h":3.5,"text":"Цвет: {{color}}","style":{"size":2.4}},{"id":"tr1kya","type":"text","x":2,"y":14.5,"w":33.5,"h":3.5,"text":"{{client}}","style":{"size":2.3}},{"id":"tqvrm2","type":"text","x":2,"y":21,"w":54,"h":3.5,"text":"Состав: {{composition}}","style":{"size":2.3}},{"id":"t88u4b","type":"text","x":36,"y":12,"w":20,"h":8,"text":"{{size}}","style":{"size":3.5,"align":"center","bold":true}},{"id":"imgoeuug","type":"barcode","x":13,"y":24.5,"w":29.5,"h":15,"src":""},{"id":"tbhhpr","type":"text","x":2,"y":1,"w":54,"h":4,"text":"{{brand}}","style":{"size":2.7,"bold":true,"align":"center"}}]}',
            ],
            [
                'id' => 2,
                'name' => 'ЧЗ',
